        ...
        let db = pool.query(`
          ...
          CREATE TABLE IF NOT EXISTS Employees (
            ...
            CONSTRAINT fk_Employees_StoreLocation1
              ...
              REFERENCES StoreLocation (idStoreLocation)
              ON DELETE CASCADE
              ON UPDATE CASCADE)
          ENGINE = InnoDB
          AUTO_INCREMENT = 9
          ...
          CREATE TABLE IF NOT EXISTS EmployeesAddress (
            address VARCHAR(45) NOT NULL,
          ...
          CREATE TABLE IF NOT EXISTS EmployeesEmail (
            email VARCHAR(45) NOT NULL,
            employees_idEmployees INT(11) NOT NULL,
            PRIMARY KEY (email),
          ...
          CREATE TABLE IF NOT EXISTS EmployeesPhone (
            phone VARCHAR(12) NOT NULL,
            employees_idEmployees INT(11) NOT NULL,
            PRIMARY KEY (phone),
          ...
          CREATE TABLE IF NOT EXISTS ProvidesInvoice (
            Customer_idCustomer INT(11) NOT NULL,
            Employees_idEmployees INT(11) NOT NULL,
          ...
          CREATE TABLE IF NOT EXISTS StoreEmail (
          ...
          CREATE TABLE IF NOT EXISTS StorePhone (
            idStoreLocation INT(11) NOT NULL,
            phone VARCHAR(12) NOT NULL,
            PRIMARY KEY (idStoreLocation),
          ...
          CREATE TABLE IF NOT EXISTS Rents (
            ...
            CONSTRAINT fk_RentalAgreement_has_Customer_Equipment
              ...
              REFERENCES RentalAgreement (idRentalAgreement)
              ON DELETE CASCADE
              ON UPDATE CASCADE)
          ENGINE = InnoDB
          DEFAULT CHARACTER SET = latin1;

          CREATE TABLE IF NOT EXISTS CreatesRentalAgreement (
            Customer_idCustomer INT(11) NOT NULL,
            Employees_idEmployees INT(11) NOT NULL,
            PRIMARY KEY (Customer_idCustomer, Employees_idEmployees),
          ...
          CREATE TABLE IF NOT EXISTS InvoiceRental (
            RentalAgreement_idRentalAgreement INT(11) NOT NULL,
